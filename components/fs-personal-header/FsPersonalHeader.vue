    ...
    <div class="fs-personal-header__info">
        <div class="fs-personal-header__col-left">
            <div class="fs-personal-header__photo">
                <img
                    :src="file ? fileUrl : getUser.avatar ? getUser.avatar : ''"
                    alt=""
                />
                <label
                    for="input"
                    ...
                    :class="{
                        'fs-personal-header__add-photo--user': getUser.avatar,
                    }"
                >
                    <FsAddPhoto />
                    <input
            ...
            <div
                ...
                class="fs-personal-header__admin-links"
            >
            ...
            <div class="fs-personal-header__user-content">
                <div class="fs-personal-header__info-block">
                    <div class="fs-personal-header__field">
                        <div class="fs-personal-header__field-name">Email</div>
