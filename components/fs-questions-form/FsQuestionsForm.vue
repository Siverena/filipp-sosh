    ...
    <div class="fs-questions-form">
        ...
        <div class="container">
            <div class="fs-questions-form__titles">
                <h2 class="fs-h2 fs-questions-form__title">
                    Остались вопросы?
                </h2>
            ...
            <div class="fs-questions-form__wrapper">
                <form
                    ...
                    <div class="fs-questions-form__fields">
                        <div class="fs-questions-form__column">
                            <template v-for="(field, i) in fields" :key="i">
                                ...
                                >
                                    <label
                                        class="fs-questions-form__label"
                                        :for="field.name"
                                        >{{ field.label
                                        }}<span
                                            class="fs-questions-form__star"
                                            v-if="field.required"
                                            >*</span
                                        ></label
                                    >
                                    <input
                                        ...
                                        :class="{
                                            'fs-questions-form__input--error':
                                                field.error,
                                        }"
                                        :type="field.type"
                                        :name="field.name"
                                    ...
                                    />
                                    <span
                                        class="fs-questions-form__error"
                                        v-if="field.error"
                                        >{{ field.error }}
                                    </span>
                                </div>
                        ...
                        <template v-for="(field, i) in fields" :key="i">
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    :class="{
                                        'fs-questions-form__textarea--error':
                                            field.error,
                                    }"
                                    :name="field.name"
                                    :id="field.name"
                    ...
                    <div class="fs-questions-form__row">
                        <div class="fs-questions-form__info-wrap">
                            <div class="fs-questions-form__attention">
                                <p>
                                    <span class="fs-questions-form__star"
                                        >*</span
                                    >Обязательное поле
                                </p>
                            </div>
                        ...
                        <div class="fs-questions-form__btn-wrap">
                            ...
                            <button
                                class="fs-btn fs-btn--dark fs-questions-form__btn"
                            >
                                Отправить
                            </button>
                        </div>
