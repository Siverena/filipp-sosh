<template>
  <section class="fs-services">
    <div class="container">
      <div class="fs-services__content">
        <FsSectionTitles class="fs-services__titles">
          <template v-slot:main> Услуги в сфере образования </template>
          <template v-slot:dop> Электронная школа </template>
        </FsSectionTitles>
